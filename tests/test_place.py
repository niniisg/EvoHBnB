...
class TestPlace(unittest.TestCase):
    ...
    def test_add_amenity(self):
        place = Place(name="Test Place", description="Nice place", address="123 Place St", city=None, latitude=0.0, longitude=0.0, number_of_rooms=2, bathrooms=1, price_per_night=100, max_guests=4)
    ...
    def test_add_review(self):
        city = City(name="Test City", country="Test Country")
        place = Place(name="Test Place", description="Nice place", address="123 Place St", city=city, latitude=0.0, longitude=0.0, number_of_rooms=2, bathrooms=1, price_per_night=100, max_guests=4)
